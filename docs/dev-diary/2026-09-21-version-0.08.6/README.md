...
| [`playtest/`](playtest/PLAYTEST.txt) | [Write the 0.08.6 amendments and build them](https://github.com/whaleyjoshua2/Dying-Earth/issues/301) | The playtest note that shipped in the 0.08.6 Windows kit as `README.txt`, filed here when 0.08.7 became the current version and its own note took `docs/playtest/`. |
