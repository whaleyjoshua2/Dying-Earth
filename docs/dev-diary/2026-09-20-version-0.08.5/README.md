...
| [`playtest/`](playtest/PLAYTEST.txt) | [Write the 0.08.5 amendments and build them](https://github.com/whaleyjoshua2/Dying-Earth/issues/287) | The playtest note that shipped in the Windows kit as `README.txt` (this version shipped for Windows only, at the designer's word), filed here when 0.08.6 replaced it at `docs/playtest/`; 0.08.4's is under [`playtest/`](../2026-09-19-version-0.08.4/playtest/PLAYTEST.txt) in its own folder. |
