...
| [`launch-hover.png`](launch-hover.png) | The Launch button's hover, eight lines and unclipped: the 60% per building, the 40-60% of the people, the Region's Army and Industry Level, the rung-4 Offence and the Accord it breaks, Earth's 20 ppm and quarter-point of Sink, and the orbit rule. Everything a player needs before firing a nuke, and nothing else. |
