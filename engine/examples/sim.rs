...
fn main() {
    ...
    for s in seed..seed + count {
        ...
        println!(
            "         | blame {:?} | share {:?} | credit {:?} | smeared {:?} | greenwashed {:?} | credits bought {:?} sold {:?} | thresholds {:?} | neutral developments {} | blockade-turns suffered {:?} imposed {:?} | war ppm {:?} nobody's {:.1} | levies {} neutral holds {}",
