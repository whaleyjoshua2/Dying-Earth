...
On any turn they set the share of their **Ducat income** that goes into it at Income, from nothing to four fifths in whole percents on a slider (since version 0.08.4; in tenths before), taken before they can spend a coin of it; Ducats got by selling are not income and never reach it. A **withdrawal** takes Ducats back out at a tenth's loss. On the top bar it is a small progress bar beside Ducats (since version 0.08.7; a figure beside Materials from 0.05.5), its balance and share on the hover.
